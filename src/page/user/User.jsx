...
import {Button, Divider, Popconfirm, message, Avatar, Modal} from 'antd';
import {useNavigate} from 'react-router';
import {useState} from "react";
import UploadPic from './UploadPic.jsx'

export default function User() {
    const [uploadPicVisible, setUploadPicVisible] = useState(false);
    ...
    const uploadPicComponent = UploadPic()

    function uploadPicBtn(id) {
        uploadPicComponent.visible(id)
    }
        ...
        },
        {
            ...
            render: (text, record) => (
                <>
                    ...
                    <Divider type="vertical"/>
                    <Button type="link" ghost onClick={() => uploadPicBtn(record.ID)}>上传头像</Button>
                    <Divider type="vertical"/>
                    <Popconfirm
                        title="删除用户"
